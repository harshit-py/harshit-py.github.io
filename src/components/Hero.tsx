  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-4xl animate-fade-in">
        <p className="font-mono text-accent mb-4 text-[#0A66C2]">Hi, my name is</p>
        <h1 className="text-4xl md:text-6xl font-bold text-[#333333] mb-4">
          John Doe
        </h1>
        <h2 className="text-3xl md:text-5xl font-bold text-[#4A5568] mb-6">
          I build with AI & Data
        </h2>
        <p className="text-lg text-[#2D3748] mb-8 max-w-2xl">
